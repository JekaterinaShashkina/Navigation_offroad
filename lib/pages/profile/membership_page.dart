...
class MembershipPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: NewAppBar(title: 'Membership', onPressed: () => Navigator.pop(context)),
      body: StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
        ...
        builder: (context, snap) {
          ...
          // ожидаем поле premium_until: Timestamp? (может быть null)
          final untilTs = data['premium_until'];
          DateTime? until;
          if (untilTs is Timestamp) until = untilTs.toDate();
          final isPremium = until != null && until.isAfter(DateTime.now());
          ...
          return ListView(
            ...
            children: [
              ...
              Text(
                isPremium ? 'You have Premium' : "You don’t have a premium membership.",
                style: hintTextStyle,
              ),
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      style: const TextStyle(fontSize: fontSize20, fontWeight: FontWeight.w700),
                    ),
                    const SizedBox(height: height8),
              ...
              const Text('Benefits', style: TextStyle(fontSize: fontSize18, fontWeight: FontWeight.w700)),
              const SizedBox(height: height12),

              // список бенефитов (заглушки)
              const _BenefitCard(title: 'Unlimited routes', subtitle: 'Lorem ipsum is simply dummy text of the printing …'),
              const SizedBox(height: height12),
              const _BenefitCard(title: 'Unlimited waypoints', subtitle: 'Lorem ipsum is simply dummy text of the printing …'),
              const SizedBox(height: height12),
              const _BenefitCard(title: 'Lorem ipsum', subtitle: 'Lorem ipsum is simply dummy text of the printing …'),
            ],
          );
        },
      ),
  ...
  String _fmt(DateTime d) {
    // простое форматирование DD.MM.YYYY без зависимостей
